...
@Service
@Transactional
public class QuestionMCQ extends QuestionObject {
	@Autowired
	...
	public QuestionObject choose() {
		QuestionObject questionResult = new QuestionMCQ();
		Question question = questionDAO.getQuestionByType("MCQ", s_id, grade, level);
