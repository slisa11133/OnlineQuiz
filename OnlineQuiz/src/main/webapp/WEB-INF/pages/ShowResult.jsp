                  ...
                  <div class="x_content">
                    ...
                    <div class="widget_summary">
                      ...
                      <div class="w_center w_55">
                        <div class="progress">
                          <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${current[0]*50}%;">
                    ...
                    <div class="widget_summary">
                      <div class="w_left w_25">
                        <span>ability of calculating</span>
                      </div>
                      <div class="w_center w_55">
                        <div class="progress">
                          <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${current[1]*50}%;">
                            <span class="sr-only">60% Complete</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="widget_summary">
                      <div class="w_left w_25">
                        <span>capacity of memory</span>
                      </div>
                      <div class="w_center w_55">
                        <div class="progress">
                          <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${current[2]*50}%;">
                            <span class="sr-only">60% Complete</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="widget_summary">
                      <div class="w_left w_25">
                        <span>ability of information integration</span>
                      </div>
                      <div class="w_center w_55">
                        <div class="progress">
                          <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${current[3]*50}%;">
                            <span class="sr-only">60% Complete</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="widget_summary">
                      <div class="w_left w_25">
                        <span>ability of applying knowledge</span>
                      </div>
                      <div class="w_center w_55">
                        <div class="progress">
                          <div class="progress-bar bg-green" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: ${current[4]*50}%;">
                            <span class="sr-only">60% Complete</span>
                          </div>
                        </div>
                      </div>
